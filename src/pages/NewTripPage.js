      ...
      <VStack style={styles.mainContainer}>
        ...
        <VStack alignItems={'center'} style={{marginBottom: -25}}>
          <TouchableOpacity
            ...
            <Image
              ...
              style={{height: '100%'}}
              source={
                coverPhoto !== null ? {uri: coverPhoto.assets[0].uri} : null
              }
            />
        ...
        <VStack alignItems={'center'}>
          <Button
            ...
            iconSource={() => (
              <Icon
                style={styles.labelActivityButton}
                size={20}
                name={'plus'}
              />
            )}
            ...
            onPress={() =>
              navigation.push('AddActivity', {
                updateActivity: response => {
                  if (!activities.includes(response)) {
        ...
        <ModalPhoto
          typeOfUpload="newTrip_cover"
          show={showModal}
          updateImage={response => setCoverPhoto(response)}
